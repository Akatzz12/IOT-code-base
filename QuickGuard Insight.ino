...
void loop() {
  ...
  // Adjusting the mapping to convert values from -50 to 100
  int xValue = map(value1, xsample, xsample + 1023, -50, 100); // mapping x value
  int yValue = map(value2, ysample, ysample + 1023, -50, 100); // mapping y value
  int zValue = map(value3, zsample, zsample + 1023, -50, 100); // mapping z value
